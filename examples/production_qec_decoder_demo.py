...
print("AZM-QOS v4.2 Production QEC Decoder Demo")
print("=" * 70)

out_dir = ROOT / "outputs" / "production_qec_decoder_demo"
spec, artifacts = init_production_project(out_dir, project_name="demo_qec_decoder")
