...
print("AZM-QOS v4.1 Production QEC Estimator Demo")
print("=" * 70)

out_dir = ROOT / "outputs" / "production_qec_estimator_demo"
spec, artifacts = init_production_project(out_dir, project_name="demo_qec_estimator")
