...
print("AZM-QOS v4.5 Production Hardware Sync Demo")
print("=" * 70)

out_dir = ROOT / "outputs" / "production_hardware_sync_demo"
spec, artifacts = init_production_project(out_dir, project_name="demo_hardware_sync")
