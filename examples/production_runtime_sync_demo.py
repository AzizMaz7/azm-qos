...
print("AZM-QOS v4.6 Production Runtime Sync Demo")
print("=" * 70)

out_dir = ROOT / "outputs" / "production_runtime_sync_demo"
spec, artifacts = init_production_project(out_dir, project_name="demo_runtime_sync")
