...
print("AZM-QOS v4.8 Production Final Export Demo")
print("=" * 70)

out_dir = ROOT / "outputs" / "production_final_export_demo"
spec, artifacts = init_production_project(out_dir, project_name="demo_final_export")
